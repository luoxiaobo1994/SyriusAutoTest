...
def random_item():
    ...
    goods_ls = ['不-定-时随-机-急-停 黑色 XXL $189', '检查右上角订-单详-情按-钮',
                '随-机上-报异-常', '扫描错-误的商-品条-码xx123', '注意检查页面文本', '多语言测试页面', '+-按-钮是-否正常',
                '进入异2常上1报 再返回', '丢3失2定1位后 是否还1能-恢-复移--动', '退出SP 重-启能否正-常加-载进入', '联想ThinkPad_T490',
...
if __name__ == '__main__':
    print(send_order(num=200, siteid="202"))
